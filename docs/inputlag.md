...
By default, the video engine used by RePlayOS introduces near zero-lag while maintaining a good performance. A special option, available in `REPLAY OPTIONS > SYSTEM > LOW LATENCY MODE`, allows users to choose different levels of input lag:
